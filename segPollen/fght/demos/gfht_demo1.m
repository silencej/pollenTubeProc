...
%
% Copyright (c) 2010 by Pau Mic?

addpath('../common');
addpath('../');
close all; clear; clc;
LAB = imread('../data/images/HLA00_lab.bmp');                                              % labelled source load
click(LAB, 'Original HLA CMRI');
% disp('Click ''enter'' to continue...'), pause;

load '../data/patterns/HLA00_pat';                                                              % R-table load (pattern)
SRC = '../data/images/HLA00_src';                                                          % raw (unlabelled) source
