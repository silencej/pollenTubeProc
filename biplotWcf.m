function h = biplotWcf(coefs,gVec,gNames,varargin)
...
gNum=max(gVec);
legendH=zeros(gNum,1);
set(obsHndl(gVec==1),'Color','r','Marker','o','MarkerFaceColor','r');
set(obsHndl(gVec==2),'Color','g','Marker','o','MarkerFaceColor','g');
legendH(1)=obsHndl(find(gVec==1,1));
legendH(2)=obsHndl(find(gVec==2,1));
if gNum>=3
    set(obsHndl(gVec==3),'Color','b','Marker','o','MarkerFaceColor','b');
    legendH(3)=obsHndl(find(gVec==3,1));
end
if gNum>=4
    set(obsHndl(gVec==4),'Color','c','Marker','o','MarkerFaceColor','c');
    legendH(4)=obsHndl(find(gVec==4,1));
end
if gNum>=5
   set(obsHndl(gVec==5),'Color','m','Marker','o','MarkerFaceColor','m');
   legendH(5)=obsHndl(find(gVec==5,1));
end
if gNum>=6
